...
export RESTIC_REPOSITORY="EPLACE_WITH_S3_OR_B2_BUCKET_URL"
export RESTIC_PASSWORD="EPLACE_WITH_RESTIC_REPOSITORY_PASSWORD"
...
export AWS_ACCESS_KEY_ID="EPLACE_WITH_AWS_ACCESS_KEY"
export AWS_SECRET_ACCESS_KEY="EPLACE_WITH_AWS_SECRET_ACCESS_KEY"
