...
OUTPUT=$(/root/OT-Smoothbrain-Backup/restic backup /root/backup/.origintrail_noderc /root/.origintrail_noderc /root/backup/arangodb3 /root/backup/arangodb3-apps 2>&1)
echo $OUTPUT
if [ $? -eq 0 ]; then
