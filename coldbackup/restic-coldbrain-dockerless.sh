...
OUTPUT=$(/root/OT-Smoothbrain-Backup/restic backup /ot-node/current/.origintrail_noderc /root/.origintrail_noderc /var/lib/arangodb3 /var/lib/arangodb3-apps 2>&1)
